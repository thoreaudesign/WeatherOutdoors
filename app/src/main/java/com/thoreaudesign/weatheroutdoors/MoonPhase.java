...
public class MoonPhase
{
	...
	public static final Map<Integer, String> PHASE_NAMES = initPhaseNames();

	public static Map<Integer, String> initPhaseNames()
    {
        Map<Integer, String> map = new HashMap<Integer, String>();

        map.put(0, "NEW_MOON");
        map.put(1, "WAXING_CRESCENT");
        map.put(2, "FIRST_QUARTER");
        map.put(3, "WAXING_GIBBOUS");
        map.put(4, "FULL_MOON");
        map.put(5, "WANING_GIBBOUS");
        map.put(6, "LAST_QUARTER");
        map.put(7, "WANING_CRESCENT");
    ...
    {
        int phaseIndex = MoonPhase.computePhaseIndex(this._curCal);

        return PHASE_NAMES.get(phaseIndex);
    }
